export const projects = [
    ...
    },
    {
        id: 3,
        name: 'Weather',
        description: 'Search by city, practice clear js, fetch, work with API',
    ...
    },
    {
        id: 4,
        name: 'Short link',
        description: 'Create short link in your reg account',
    ...
    {
        id: 5,
        name: 'Shop clear flex',
        description: 'Flexbox, one of the first works of the Desktop version',
